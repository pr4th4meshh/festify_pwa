...
const SignIn = () => {
  ...
  return (
    <div className="px-6 py-[150px] ">
      <h1 className="text-[32px] font-semibold ">
        Welcome to <br />{" "}
        <span className="font-bold text-[78px] relative bottom-4 ">
          Festify
        </span>
      </h1>
      ...
      <div className=" border-t border-red-500 ">
        ...
        <form action="" method="post">
          <input
            ...
            className="w-full border py-4 px-5 "
          />
        </form>
      </div>
      <div className="border-t border-red-500 mt-[100px] flex justify-center flex-col">
        <h3 className="text-center pt-4">Sign in with Google</h3>
        <button className=" flex self-center mt-2 rounded-full border p-3 border-red-500" onClick={handleGoogleSignIn}>
          <svg
